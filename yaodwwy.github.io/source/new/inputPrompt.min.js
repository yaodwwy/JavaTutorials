function myEncodeURI(param) {
    param = param.replace(/(^\s+)|(\s+$)/, "").replace(/_/g, "_5F").replace(/\./g, "_2E").replace(/\+/g, "_2B").replace(/\//g, "_2F");
...
(function (param) {
    param.fn.slide = function (b) {
        var config = {slideWidth: 150, autoplay: true, duration: 15000, showSlideIndex: true};
        var b = param.extend(config, b);
        return this.each(function () {
            ...
            function l(o, s) {
                param("#slideInner").stop();
                if (s == false || i.autoplay == false || o != 0) {
                    if (o == 0 && s) {
                        param("#slideInner").css({marginLeft: i.slideWidth / 2})
                    }
                    if (o == g - 1 && !s) {
                        param("#slideInner").css({marginLeft: i.slideWidth * (-g)})
                    }
                    param("#slideInner").animate({marginLeft: i.slideWidth * (-o)}, "", "", function () {
                        h(o);
                        if (i.autoplay == true) {
                            p(i.duration)
                        }
                    ...
                    param("#slideInner").animate({marginLeft: i.slideWidth * (-g)}, "", "", function () {
                        param("#slideInner").css("marginLeft", 0);
                        h(o);
                        if (i.autoplay == true) {
                            p(i.duration)
                        }
            ...
            function h(o) {
                if (i.showSlideIndex == true) {
                    param("#slideIndex").text(parseInt(o + 1) + "/" + g)
                }
            }
        })
    }
...
(function (h, j, a, f) {
    ...
    h(function () {
        ...
        var prompted = k.inputPrompt({
            driver: "dict",
            width: k.outerWidth(),
            trigger: h("#sugg-trigger"),
            onchoose: function (r) {
                if (prompted[0]) {
                    prompted[0].driver.query(r)
                }
            }
        });
        try {
