...
public class SendMailTest { 
    ...
    // 发件人 
    private static String from = "yaodwwy@163.com"; 

    // 收件人 
    private static String to = "yaodwwy@qq.com"; 
    ...
    public static void sendHtmlWithInnerImageEmail() throws MessagingException { 
        ...
        message.setRecipients(RecipientType.TO, InternetAddress.parse(to)); 
        // 抄送 
        message.setRecipient(RecipientType.CC, new InternetAddress("yaodwwy@live.com")); 
        // 密送 (不会在邮件收件人名单中显示出来) 
        message.setRecipient(RecipientType.BCC, new InternetAddress("yaoo@live.cn")); 
        // 发送时间 
        message.setSentDate(new Date()); 
        ...
        // 设置内嵌图片邮件体 
        DataSource ds = new FileDataSource(new File("d:/aneos/test.jpg")); 
        DataHandler dh = new DataHandler(ds); 
        imagePart.setDataHandler(dh); 
        imagePart.setContentID("aneop.jpg");  // 设置内容编号,用于其它邮件体引用 
        ...
        htmlBodypart.setContent("<span style='color:red;'>这是带内嵌图片的HTML邮件哦！！！<img src=\"cid:aneop.jpg\" /></span>","text/html;charset=utf-8"); 
    ...
    public static void sendMultipleEmail() throws Exception { 
        ...
        message.setRecipients(RecipientType.TO,  
                ...
                new InternetAddress("yaodwwy@qq.com", "qq张三", charset), 
                new InternetAddress("yaoo@live.cn", "live李四", charset), 
            } 
        ); 
        // 设置抄送 
        message.setRecipient(RecipientType.CC, new InternetAddress("yaoo@live.cn","王五_live",charset)); 
        // 设置密送 
        message.setRecipient(RecipientType.BCC, new InternetAddress("yaodwwy@qq.com", "赵六_QQ", charset)); 
        // 设置发送时间 
        message.setSentDate(new Date()); 
        // 设置回复人(收件人回复此邮件时,默认收件人) 
        message.setReplyTo(InternetAddress.parse("\"" + MimeUtility.encodeText("田七") + "\" <493106061@qq.com>")); 
        // 设置优先级(1:紧急   3:普通    5:低) 
        ...
        DataSource ds1 = new FileDataSource("d:/aneos/test.jpg"); 
        DataHandler dh1 = new DataHandler(ds1); 
        attach1.setFileName(MimeUtility.encodeText("test.jpg")); 
        attach1.setDataHandler(dh1); 

        // 附件2 
        DataSource ds2 = new FileDataSource("d:/java/error.log"); 
        DataHandler dh2 = new DataHandler(ds2); 
        attach2.setDataHandler(dh2); 
        attach2.setFileName(MimeUtility.encodeText("error.log")); 
        ...
        // 正文图片 
        DataSource ds3 = new FileDataSource("d:/aneos/test.jpg"); 
        DataHandler dh3 = new DataHandler(ds3); 
        imgPart.setDataHandler(dh3); 
        imgPart.setContentID("test.jpg"); 
    ...
    static class MyAuthenticator extends Authenticator { 
        ...
        private String username = "yaodwwy"; 
