...
public enum ErrorCode {
    ...
    UpdateSuccess(70001, "修改成功"),
    UpdateError(70001, "修改失败"),
    GetError(70001, "未get到你的信息"),
    GoodsNotFoundError(70001, "请添加商品"),
    CancelSuccess(70001, "取消成功"),
    CancelError(70001, "取消失败"),
    NonCancelAbilityError(70001, "该询已存在报价，不能结束或取消该询价"),
    QuoteFreightLimitError(70001, "运费输入不正确"),
    NullError(70001, "请输入必填项"),
    QuoteMinTimeStrategyError(70001, "报价最小时间不能小于30天"),
    WebError(70001, "页面异常,请重新操作"),
    ExpireError(70001, "询价截止日期不能小于等于当前时间"),
    PackageNumError(70001, "包装商品数量不能小于或等于0"),
    InquiryGoodsOverdueError(70001, "该询价商品结束"),
    RequiredError(70001,"必填非空验证"),
    QuotationGoodsAmountError(70001, "总价验证失败"),
    InquiryStatusError(70001, "询价单及状态验证失败"),
    InquiryVendorScopeError(70001, "询价供应商范围验证失败"),
    InquiryQuoteMinTimeStrategyError(70001, "报价有效期设置过短"),
    InquiryQuoteTotalSpecStrategyError(70001, "询价商品替代要求规格验证失败"),
    InquiryQuoteTotalStrategyError(70001, "询价商品替代要求验证失败"),
    CategoryNullError(70001, "请选择平台类目"),;
