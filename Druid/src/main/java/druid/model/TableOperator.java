...
public class TableOperator {
    ...
    private void dropSeq() throws SQLException {
        ...
        try {
            ...
            stmt.execute("DROP SEQUENCE public.seq_big RESTRICT");
        } finally {
            if (stmt != null) {
                stmt.close();
            }
    ...
    public void createSequence() throws SQLException {
        ...
        try {
            StringBuffer ddl = new StringBuffer();
            ddl = new StringBuffer("CREATE SEQUENCE seq_big");
            conn = dataSource.getConnection();
            stmt = conn.createStatement();
    ...
    public void createTable() throws SQLException {
        this.createSequence();
        StringBuffer ddl = new StringBuffer();
        ddl.append("CREATE TABLE t_big (FID INT DEFAULT NEXTVAL('seq_big') PRIMARY KEY ");
        for (int i = 0; i < COUNT; ++i) {
            ddl.append(", ");
            ddl.append("F" + i);
